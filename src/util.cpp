...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\FidChain
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\FidChain
    // Mac: ~/Library/Application Support/FidChain
    // Unix: ~/.FidChain
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FidChain";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "FidChain.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "FidCore.pid"));
