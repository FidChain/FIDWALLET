...
{
    resize(850+95, 550);
    setWindowTitle(tr("FidChain") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FidChain address"));
    ...
    aboutAction = new QAction(tr("&About FidChain"), this);
    aboutAction->setToolTip(tr("Show information about FidChain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FidChain"));
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/FidChain_testnet"));
            setWindowIcon(QIcon(":icons/FidChain_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/FidChain_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FidChain client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FidChain client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FidChain network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FidChain address or malformed URI parameters."));
    }
